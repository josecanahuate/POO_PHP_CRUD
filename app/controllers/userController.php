	...
	class userController extends mainModel{
		...
		public function registrarUsuarioControlador(){
    		...
    		if($_FILES['usuario_foto']['name']!="" && $_FILES['usuario_foto']['size']>0){
		        ...
		        if(($_FILES['usuario_foto']['size']/1024)>5120){
		        	$alerta=[
						"tipo"=>"simple",
						"titulo"=>"Ocurrió un error inesperado",
						"texto"=>"La imagen supera el peso permitido",
						"icono"=>"error"
					];
					return json_encode($alerta);
		            exit();
			...
			if($registrar_usuario->rowCount()==1){
				...
				# si no se registro el usuario correctamente, se elimina la imagen guardada
		...
		public function actualizarUsuarioControlador(){
			...
			# para actualizar un usuario se debe ingresar el usuario y clave del admin
			# input usuario y clave del usuario
